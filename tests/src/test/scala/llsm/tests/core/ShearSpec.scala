...
class ShearSpec extends BaseSuite {
  "A ShearIntervalTransform" should "c[shearDimension] += c[referenceDimension] * shearFactor" in forAll((Gen.choose(2, 10), "nDim"), (Gen.choose(0, 9), "shearDimension"), (Gen.choose(0, 9), "referenceDimension"), (Gen.choose(-5, 5), "shearFactor"), (Gen.choose(1L, 1000L), "c")) {
    (nDim: Int, shearDimension: Int, referenceDimension: Int, shearFactor: Int, c: Long) =>
      whenever(nDim > 1 && shearDimension < nDim && referenceDimension < nDim && shearDimension != referenceDimension && shearFactor != 0) {
        ...
        val st = new ShearIntervalTransform(nDim, shearDimension, referenceDimension, shearFactor)
  ...
  it should "throw an IllegalArgumentException when the shearDimension or referenceDimension are >= nDim" in forAll("nDim", "shearDimension", "referenceDimension") { (nDim: Int, shearDimension: Int, referenceDimension: Int) =>
    whenever(shearDimension >= nDim || referenceDimension >= nDim) {
      assertThrows[IllegalArgumentException] {
        new ShearIntervalTransform(nDim, shearDimension, referenceDimension, 1)
      }
  }}
  ...
  "A RealShearTransform" should "c[shearDimension] += c[referenceDimension] * shearFactor" in forAll((Gen.choose(2, 10), "nDim"), (Gen.choose(0, 9), "shearDimension"), (Gen.choose(0, 9), "referenceDimension"), (Gen.choose(-5.0, 5.0), "shearFactor"), (Gen.choose(1.0, 1000.0), "c")) {
    (nDim: Int, shearDimension: Int, referenceDimension: Int, shearFactor: Double, c: Double) =>
      whenever(nDim > 1 && shearDimension < nDim && referenceDimension < nDim && shearDimension != referenceDimension && shearFactor != 0.0) {
        val source: Array[Double] = Array.fill[Double](nDim)(c)
        val target: Array[Double] = Array.ofDim[Double](nDim)

        val st = new RealShearTransform(nDim, shearDimension, referenceDimension, shearFactor)
