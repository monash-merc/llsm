...
case class WaveformMetadata(wfType: String, nSlices: Long, zPZTOffset: Double, sPZTOffset: Double, channels: List[WaveformMetadata.Channel], nFrames: Int, cycle: String, zmotion: String)
...
object WaveformMetadata {
  ...
  case class Stage(channel: Int, offset: Double, interval: Double, excitationPixels: Long)
